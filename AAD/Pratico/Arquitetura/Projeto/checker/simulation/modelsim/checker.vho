...
-- an[10]	=>  Location: PIN_H13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[11]	=>  Location: PIN_C20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[12]	=>  Location: PIN_W19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[14]	=>  Location: PIN_D6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[15]	=>  Location: PIN_C13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[16]	=>  Location: PIN_B17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[21]	=>  Location: PIN_A8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[22]	=>  Location: PIN_H14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- error	=>  Location: PIN_L19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[5]	=>  Location: PIN_K22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[17]	=>  Location: PIN_M22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[0]	=>  Location: PIN_N16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[1]	=>  Location: PIN_N21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[2]	=>  Location: PIN_L18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[3]	=>  Location: PIN_N20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[4]	=>  Location: PIN_M16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[6]	=>  Location: PIN_N19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[7]	=>  Location: PIN_L22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[8]	=>  Location: PIN_K21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[9]	=>  Location: PIN_M18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[13]	=>  Location: PIN_P18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[18]	=>  Location: PIN_K17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[19]	=>  Location: PIN_M20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[20]	=>  Location: PIN_L17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- an[23]	=>  Location: PIN_M21,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \ALT_INV_an[13]~input_o\ : std_logic;
...
\ALT_INV_an[13]~input_o\ <= NOT \an[13]~input_o\;
...
-- Equation(s):
-- \err|y~1_combout\ = ( \an[7]~input_o\ & ( !\an[9]~input_o\ $ (!\an[8]~input_o\ $ (!\an[6]~input_o\ $ (\an[13]~input_o\))) ) ) # ( !\an[7]~input_o\ & ( !\an[9]~input_o\ $ (!\an[8]~input_o\ $ (!\an[6]~input_o\ $ (!\an[13]~input_o\))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_an[9]~input_o\,
	datab => \ALT_INV_an[8]~input_o\,
	datac => \ALT_INV_an[6]~input_o\,
	datad => \ALT_INV_an[13]~input_o\,
	datae => \ALT_INV_an[7]~input_o\,
...
-- Equation(s):
-- \err|y~0_combout\ = ( \an[1]~input_o\ & ( \an[2]~input_o\ & ( !\an[4]~input_o\ $ (!\an[3]~input_o\ $ (\an[0]~input_o\)) ) ) ) # ( !\an[1]~input_o\ & ( \an[2]~input_o\ & ( !\an[4]~input_o\ $ (!\an[3]~input_o\ $ (!\an[0]~input_o\)) ) ) ) # ( \an[1]~input_o\ 
-- & ( !\an[2]~input_o\ & ( !\an[4]~input_o\ $ (!\an[3]~input_o\ $ (!\an[0]~input_o\)) ) ) ) # ( !\an[1]~input_o\ & ( !\an[2]~input_o\ & ( !\an[4]~input_o\ $ (!\an[3]~input_o\ $ (\an[0]~input_o\)) ) ) )
...
PORT MAP (
	...
	datac => \ALT_INV_an[0]~input_o\,
	datae => \ALT_INV_an[1]~input_o\,
...
-- Equation(s):
-- \err|y~2_combout\ = ( \an[20]~input_o\ & ( !\an[18]~input_o\ $ (!\an[19]~input_o\ $ (!\an[23]~input_o\)) ) ) # ( !\an[20]~input_o\ & ( !\an[18]~input_o\ $ (!\an[19]~input_o\ $ (\an[23]~input_o\)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_an[18]~input_o\,
	datac => \ALT_INV_an[19]~input_o\,
	datad => \ALT_INV_an[23]~input_o\,
	datae => \ALT_INV_an[20]~input_o\,
...
-- Equation(s):
-- \err|y~3_combout\ = ( \err|y~2_combout\ & ( \an[5]~input_o\ & ( !\an[17]~input_o\ $ (!\err|y~1_combout\ $ (\err|y~0_combout\)) ) ) ) # ( !\err|y~2_combout\ & ( \an[5]~input_o\ & ( !\an[17]~input_o\ $ (!\err|y~1_combout\ $ (!\err|y~0_combout\)) ) ) ) # ( 
-- \err|y~2_combout\ & ( !\an[5]~input_o\ & ( !\an[17]~input_o\ $ (!\err|y~1_combout\ $ (!\err|y~0_combout\)) ) ) ) # ( !\err|y~2_combout\ & ( !\an[5]~input_o\ & ( !\an[17]~input_o\ $ (!\err|y~1_combout\ $ (\err|y~0_combout\)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_an[17]~input_o\,
	datab => \err|ALT_INV_y~1_combout\,
	datac => \err|ALT_INV_y~0_combout\,
	datae => \err|ALT_INV_y~2_combout\,
	dataf => \ALT_INV_an[5]~input_o\,
