...
/**
 * Client side of the Game of the Rope (Coach).
 *
...
public class ClientGameOfTheRopeCoach {
     ...
     *             args[0] - name of the platform where is located the Referee Site  server
     ...
     *             args[4] - name of the platform where is located the Play Ground server
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < SimulPar.N; i++) {
            coach[i] = new Coach("Coa_" + (i + 1), (i), siteStub, plGrndStub, benchStub);
        }
        ...
        for (int i = 0; i < SimulPar.N; i++) {
            ...
            GenericIO.writelnString("The Coa_ " + coach[i] + " has terminated.");
        }
        GenericIO.writelnString();
        siteStub.shutdown();
        benchStub.shutdown();
