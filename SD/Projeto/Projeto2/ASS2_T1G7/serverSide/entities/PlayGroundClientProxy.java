...
/**
 *  Service provider agent for access to the Play Ground.
 *
...
public class PlayGroundClientProxy extends Thread implements RefereeCloning, CoachCloning, ContestantCloning
{
   ...
   */
   ...
   private PlayGroundInterface plGrndInter;
   ...
   *     @param plGrndInter interface to the play ground
   */

   public PlayGroundClientProxy (ServerCom sconi, PlayGroundInterface plGrndInter)
   {
      super ("PlayGroundProxy_" + PlayGroundClientProxy.getProxyId ());
      this.sconi = sconi;
      this.plGrndInter = plGrndInter;
   }
   ...
   */
   ...
   public void run ()
   {
     ...
     /* service providing */
      ...
      try
      { outMessage = plGrndInter.processAndReply (inMessage);         // process it
      }
