...
public class RefereeSiteClientProxy extends Thread implements RefereeCloning, CoachCloning, ContestantCloning
{
   ...
   */
   ...
   private RefereeSiteInterface siteInter;
   ...
   *     @param siteInter interface to the Referee site
   */

   public RefereeSiteClientProxy (ServerCom sconi, RefereeSiteInterface siteInter)
   {
      super ("RefereeSiteProxy_" + RefereeSiteClientProxy.getProxyId ());
      this.sconi = sconi;
   ...
   */
   ...
   {
      Class<?> cl = null;                                            // representation of the RefereeSiteClientProxy object in JVM
   ...
   */
   ...
   public void run ()
   {
     ...
     /* service providing */
      ...
      try
      { outMessage = siteInter.processAndReply (inMessage);         // process it
      }
