...
/**
 *    Server side of the Play Ground of Information.
 *
...
public class ServerGameOfTheRopePlayGround 
{
   ...
   */
   ...
   {
      PlayGround plGrnd;                                              // play ground (service to be rendered)
      PlayGroundInterface plGrndInter;                                // interface to the play ground
     ...
     /* service is established */
      ...
      plGrnd = new PlayGround (reposStub);                                      // service is instantiated
      plGrndInter = new PlayGroundInterface (plGrnd);                            // interface to the service is instantiated
     ...
     PlayGroundClientProxy cliProxy;                                // service provider agent
      ...
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new PlayGroundClientProxy (sconi, plGrndInter);    // start a service provider agent to address
