...
nutcpF443=data.loc[(data['proto']=='tcp')&(data['port']==443)].groupby(['src_ip'])['up_bytes'].count()
print("\nnutcpF443: \n" + str(nutcpF443))

# Add the country code and the organization to flow data
...
server_ips.head(8).plot(kind='bar', x='index', y='counts')
